...
| Omen-slam bow (fractured base) | mid–high | high (+Proj: Greater EV ≈ +77 / Perfect chases T1) / buy-don't-craft (Crit) † | medium | any | [omen-slam-bow.md](omen-slam-bow.md) |
...
| **high (~40+ div)** | Desecration Lich at volume | Omen-slam bow (+Proj Greater build, ~196 div bankroll, EV ≈ +77; Perfect build chases the ~460–630 tier) · Genesis Breach Ring (week-1–3 only) | pure-ES targets (low demand this patch) |
